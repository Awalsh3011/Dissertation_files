# -*- coding: utf-8 -*-
"""Dissertation code- Over sampling SMOTE.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1v6WcshxWugZZqGZ1JOOYqRHoqMNMoiuS
"""
...
randomForest = RandomForestClassifier(criterion='entropy', max_depth=8, max_features='sqrt',
                       n_estimators=200)
...
tree = DecisionTreeClassifier(criterion='entropy', max_depth=5, min_samples_leaf=14)
tree.fit(x_train_smote, y_train_smote)
y_predict = tree.predict(x_test)
tree_accuracy = metrics.accuracy_score(y_test, y_predict)
print('Accuracy of Decision Tree = {} '.format(tree_accuracy))
...
grid_search = abm_grid.fit(x_train_smote, y_train_smote)
print('Best Parameters: ', grid_search.best_params_)
print('Best estimators: ', grid_search.best_estimator_)

model = AdaBoostClassifier(learning_rate=1, n_estimators=120)
model.fit(x_train_smote, y_train_smote)
y_predict = model.predict(x_test)
xg_accuracy = metrics.accuracy_score(y_test, y_predict)
print('Accuracy of XGBoost = {} '.format(xg_accuracy))
...
nbm = GaussianNB()
nbm.fit(x_train_smote, y_train_smote)
...
grid_search = svm_grid.fit(x_train_smote, y_train_smote)
print('Best Parameters: ', grid_search.best_params_)
print('Best estimators: ', grid_search.best_estimator_)
